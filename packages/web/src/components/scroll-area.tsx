  ...
  return (
    ...
    >
      <ScrollAreaPrimitive.Viewport
        className={(state) => {
          return cn(
            "-outline-offset-1 h-full overscroll-contain rounded-md outline-1 outline-gray-200 focus-visible:outline-2 focus-visible:outline-blue-800",
      ...
      <ScrollAreaPrimitive.Corner className={"size-8 bg-red-500"} />
    </ScrollAreaPrimitive.Root>
  );
};
