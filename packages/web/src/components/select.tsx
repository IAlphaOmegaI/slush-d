...
export const SelectTrigger = ({
  ...
  return (
    <SelectPrimitive.Trigger
      className={(state) => {
        return cn(
          "focus-visible:-outline-offset-1 flex h-10 min-w-36 select-none items-center justify-between gap-3 rounded-md border border-gray-200 pr-3 pl-3.5 text-base text-gray-900 hover:bg-gray-100 focus-visible:outline-2 focus-visible:outline-blue-800 active:bg-gray-100 data-popup-open:bg-gray-100",
